...
-------------------------------------------------------------*/
    ...
    $('.investor-stock-track').slick({
        ...
        fade: true,
        dots:false,
        prevArrow : $('.investor-stock-prev'),
        nextArrow : $('.investor-stock-next'),
        arrows:true
    });
    ...
    if ($('#env-recycle-graph').length > 0) {
        ...
        var option = {
            ...
            legend: {
                bottom: '2%',
                data: [
                    '음식물처리기', '냉장고', '밥솥', '인덕션레인지', 
                    '공기청정기', '정수기', '김치냉장고', '무선청소기', 
                    '냉동고', '에어컨', '로봇청소기', '세탁기', '총계'
                ]
            },
            xAxis: {
                type: 'category',
            ...
            series: [
                { name: '음식물처리기', type: 'bar', stack: 'total', barWidth: '35%', data: [0, 7, 10, 10], itemStyle: { color: '#56a3f1' } },
                { name: '냉장고', type: 'bar', stack: 'total', barWidth: '35%', data: [0, 0, 2, 2], itemStyle: { color: '#f88c3d' } },
                { name: '밥솥', type: 'bar', stack: 'total', barWidth: '35%', data: [0, 0, 31, 31], itemStyle: { color: '#a6a6a6' } },
                { name: '인덕션레인지', type: 'bar', stack: 'total', barWidth: '35%', data: [0, 0, 7, 8], itemStyle: { color: '#ffc000' } },
                { name: '공기청정기', type: 'bar', stack: 'total', barWidth: '35%', data: [38, 38, 38, 38], itemStyle: { color: '#4171cd' } },
                { name: '정수기', type: 'bar', stack: 'total', barWidth: '35%', data: [0, 4, 4, 4], itemStyle: { color: '#70ad47' } },
                { name: '김치냉장고', type: 'bar', stack: 'total', barWidth: '35%', data: [0, 0, 2, 4], itemStyle: { color: '#1f4e79' } },
                { name: '무선청소기', type: 'bar', stack: 'total', barWidth: '35%', data: [0, 0, 2, 2], itemStyle: { color: '#843c0c' } },
                { name: '냉동고', type: 'bar', stack: 'total', barWidth: '35%', data: [0, 0, 2, 4], itemStyle: { color: '#595959' } },
                { name: '에어컨', type: 'bar', stack: 'total', barWidth: '35%', data: [0, 0, 0, 2], itemStyle: { color: '#26b99a' } },
                { name: '로봇청소기', type: 'bar', stack: 'total', barWidth: '35%', data: [0, 0, 0, 2], itemStyle: { color: '#e74c3c' } },
                { name: '세탁기', type: 'bar', stack: 'total', barWidth: '35%', data: [0, 0, 0, 2], itemStyle: { color: '#9b59b6' } },
                {
                    name: '총계',
                    type: 'line',
                    data: [38, 49, 98, 109],
        ...
        var option = {
            ...
            tooltip: {
                ...
                formatter: function (params) {
                    ...
                    params.forEach(item => {
                        if (item.value > 0) {
                            result += `${item.marker} ${item.seriesName}: ${item.value.toLocaleString()} 톤<br/>`;
                        }
                    });
                    return result;
                }
            ...
            legend: {
                bottom: '2%',
                data: ['전기정수기', '공기청정기', '전기밥솥', '음식물처리기', '펫드라이룸', '전기레인지', '합계']
            },
            xAxis: {
                type: 'category',
